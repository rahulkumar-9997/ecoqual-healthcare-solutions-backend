...
<html lang="en" class="h-100">
   <head>
      <!-- Title Meta -->
      <meta charset="utf-8" />
      <title>Ecoqual Healthcare Solutions | Admin Login</title>
      <meta name="viewport" content="width=device-width, initial-scale=1.0">
      <meta name="description" content="A fully responsive premium admin dashboard template" />
      <meta name="author" content="Techzaa" />
      <meta http-equiv="X-UA-Compatible" content="IE=edge" />
      <!-- App favicon -->
      <link rel="shortcut icon" href="{{asset('backend/assets/logo.svg')}}">
                        ...
                        <div class="py-lg-2" style="padding: 30px;border-radius: 10px; box-shadow:0px 0px 10px 0px rgb(0 0 0 / 6%);">
                           ...
                           <div class="d-flex flex-column h-100 justify-content-center">
                              <div class="auth-logo mb-3">
                                 ...
                                 <img src="{{asset('backend/assets/logo.svg')}}" height="100" alt="logo dark">
                                 </a>
                                 <a href="{{route('login')}}" class="logo-light">
                                 <img src="{{asset('backend/assets/logo.svg')}}" height="100" alt="logo light">
                                 </a>
                              </div>
                                 ...
                                 <form action="{{route('login')}}" class="authentication-form" method="post">
                                    ...
                                    <div class="mb-3">
                                       <label class="form-label" for="example-email">Email OR User id</label>
                                        <input type="text" value="" class="form-control border-end-0" name="email" placeholder="Email or user id">
                                    </div>
                                    <div class="mb-3">
