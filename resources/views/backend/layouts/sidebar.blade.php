...
<div class="main-nav">
   ...
   <div class="logo-box">
      ...
      <img src="{{asset('backend/assets/logo.svg')}}" class="logo-sm" alt="logo sm">
      <img src="{{asset('backend/assets/logo.svg')}}" class="logo-lg" alt="logo dark">
      </a>
      <a href="{{route('dashboard')}}" class="logo-light" style="text-align: center;">
      <img src="{{asset('backend/assets/logo.svg')}}" class="logo-sm" alt="logo sm">
      <img src="{{asset('backend/assets/logo.svg')}}" style="width: 177px; height: 45px;" class="logo-lg" alt="logo light">
      </a>
   </div>
