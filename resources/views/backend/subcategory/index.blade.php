   ...
   <div class="row">
      <div class="col-xl-12">
         <div class="card">
            ...
            <div class="card-body">
            @if (isset($data['subcategory_list']) && $data['subcategory_list']->count() > 0)
                  ...
                  <table id="example-1" class="table align-middle mb-0 table-hover table-centered">
                     ...
                     <tbody>
                        @php
                           $sr_no = 1;
                        @endphp
                        @foreach($data['subcategory_list'] as $subcategory_list_row)
                           ...
                           <tr>
                              ...
                              <td>{{ $subcategory_list_row->category->title }}</td>
                             
                              
                              <td>
                                 @if($subcategory_list_row->status == 'on')
