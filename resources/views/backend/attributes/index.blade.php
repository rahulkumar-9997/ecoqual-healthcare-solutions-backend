                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td>
                              ...
                              @php
                              $content = '<br>Images no added.';
                              if (!empty($value->images)) {
                                 $content = '<br><b>Images added.</b>';
                              }
                              @endphp
                              <a href="{{ route('product-catalog-attributes-value', $value->id) }}">
                                 <span class="mb-1 mt-1 badge bg-light-subtle text-muted border py-1 px-1" data-bs-toggle="tooltip" data-bs-html="true" data-bs-original-title="{{ $value->name }} {!! $content !!}">
                                    {{ $value->name }}
                                    <span class="badge bg-primary ms-1" data-bs-toggle="tooltip" data-bs-original-title="Total Products on This Attributes Value">
