        ...
        <tbody>
            ...
            @foreach($data['product_list'] as $product)
                <tr class="product-row">
                    ...
                    <td>
                        <span class="badge bg-orange">{{ $product->ingredients->count() }}</span>
                    </td>
                    <td>
                        <span class="badge bg-info">{{ $product->specifications->count() }}</span>
                    </td>
                    <td>
                        <span class="badge bg-red">{{ $product->additionalFeatures->count() }}</span>
                    </td>
