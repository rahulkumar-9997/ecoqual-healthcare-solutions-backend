            ...
            <div class="row" id="otherFields">
               <div class="col-xl-7 col-lg-7">
                  ...
                  @if($attributesWithValues->isNotEmpty())
                     <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center gap-1">
                           <h4 class="card-title">
                              Primary Product Attributes <span class="text-green">(Optional)</span>
                           </h4>
                        </div>
                        <div class="card-body">
                           <div class="row">
                  ...
                  <div class="card">
                     <div class="card-header d-flex justify-content-between align-items-center gap-1">
                        <h4 class="card-title">
                           Product Attributes <span class="text-success">(Optional)</span>
                        </h4>
                        ...
                        <div class="row" id="attribute-row-0">
                           ...
                           <div class="col-lg-6">
                              <div class="mb-1">
                                 ...
                                 <input type="text" name="product_attributes_value[0][]" id="pro-att-value-0" class="form-control" placeholder="Enter attributes value comma separated" >
                              </div>
                           </div>
                        </div>
                  ...
                  <div class="card">
                     <div class="card-header d-flex justify-content-between align-items-center gap-1">
                        ...
                        <button class="btn btn-primary add-more-material btn-sm" type="button">Add More Product Material</button>
                     </div>
                     <div class="card-body add-more-material-append">
                        <div class="row" id="material-row-0">                           
                           <div class="col-lg-12">
                              <div class="mb-1">
                                 <input type="text" name="product_material[]" id="product_material_0" class="form-control" placeholder="Enter material" >
                              </div>
                           </div>
                        </div>
                     </div>
                  ...
                  <div class="card">
                     <div class="card-header d-flex justify-content-between align-items-center gap-1">
                        ...
                        <button class="btn btn-primary add-more-ingredients btn-sm" type="button">Add More Product Ingredients</button>
                     </div>
                     <div class="card-body add-more-ingredients-append">
                        <div class="row" id="ingredients-row-0">                           
                           <div class="col-lg-12">
                              <div class="mb-1">
                                 <input type="text" name="product_ingredients[]" id="product_ingredients_0" class="form-control" placeholder="Enter ingredients" >
                              </div>
                           </div>
                        </div>
                     </div>
                  ...
                  <div class="card">
                     <div class="card-header d-flex justify-content-between align-items-center gap-1">
                        ...
                        <button class="btn btn-primary add-more-specifications btn-sm" type="button">Add More Product Specifications</button>
                     </div>
                     <div class="card-body add-more-specifications-append">
                        <div class="row" id="specifications-row-0">                           
                           <div class="col-lg-12">
                              <div class="mb-1">
                                 <input type="text" name="product_specifications[]" id="product_specifications_0" class="form-control" placeholder="Enter specifications" >
                              </div>
                           </div>
                        </div>
                     </div>
                  ...
                  <div class="card">
                     ...
                     <div class="card-body add-more-additional-feature-append">
                        <div class="row" id="additional-feature-row-0">                           
                           <div class="col-lg-12">
                              <div class="mb-1">
                                 <input type="text" name="additional_feature_key_value[]" id="additional-feature-key-value-0" class="form-control" placeholder="Enter additional feature value" >
                              </div>
                           </div>
                        </div>
                     </div>
                        ...
                        <div class="row">
                           <div class="col-lg-12">
                              <div class="mb-1">
                                 ...
                                 <textarea class="form-control bg-light-subtle" id="short_description" rows="4" name="short_description" placeholder="Short description about product"></textarea>
                              </div>
                           </div>
                        </div>
                        <div class="row">
...
<script src="{{asset('backend/assets/js/pages/product-create-append.js')}}" type="text/javascript"></script> 
<script>
               ...
               <div class="col-lg-5">
                  <div class="mb-1">
                        <!--<select class="js-example-basic-multiple" name="product_attributes_value[${attributeCount}][]" id="pro-att-value-${attributeCount}" multiple="multiple">
                         ...
                         <input type="text" name="product_attributes_value[${attributeCount}][]" id="pro-att-value-${attributeCount}" class="form-control" placeholder="Enter attributes value comma separated" >
                  </div>
               </div>
               <div class="col-lg-2">
