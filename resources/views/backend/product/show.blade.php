                ...
                <div class="table-responsive1">
                    <table class="table align-middle mb-0 table-hover table-centered">
                        ...
                        <tr>
                            ...
                            <td>
                                @if($data['product_details']->materials->isNotEmpty())
                                    <ul>
                                        @foreach($data['product_details']->materials as $index => $materials)
                                            <li>
                                                <span> {{ $materials->material }}  </span>                       
                                            </li>
                                        @endforeach
                                    </ul>
                                @else
                        ...
                        <tr>
                            ...
                            <td>
                                @if($data['product_details']->ingredients->isNotEmpty())
                                    <ul>
                                        @foreach($data['product_details']->ingredients as $index => $ingredients)
                                            <li>
                        ...
                        <tr>
                            ...
                            <td>
                                @if($data['product_details']->specifications->isNotEmpty())
                                    <ul>
                                        @foreach($data['product_details']->specifications as $index => $specifications)
                                            <li>
                                                <span> {{ $specifications->specification }}  </span>                       
                                            </li>
                                        @endforeach
                                    </ul>
                                @else
                        ...
                        <tr>
                            ...
                            <td>
                                @if($data['product_details']->additionalFeatures->isNotEmpty())
                                    <ul>
                                        @foreach($data['product_details']->additionalFeatures as $index => $additionalFeatures)
                                            <li>
                                                <span> {{ $additionalFeatures->product_additional_featur_value }}  </span>                       
                                            </li>
                                        @endforeach
                                    </ul>
                                @else
